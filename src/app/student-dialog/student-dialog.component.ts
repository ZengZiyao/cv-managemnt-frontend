...
export class StudentDialogComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.studentCopy.id === undefined) {
      this.studentService.addStudent(data).subscribe(() => this.dialogRef.close());
    } else {
      this.studentService.updateStudent(this.studentCopy.id, data).subscribe(() => this.dialogRef.close());
    }
  }
