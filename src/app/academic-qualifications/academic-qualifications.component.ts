...
export class AcademicQualificationsComponent implements OnInit {
  ...
  constructor(private dialog: MatDialog, private academicQualificationService: AcademicQualificationService) { }

  ngOnInit(): void {
    this.academicQualificationService.getAcademicQualifications().subscribe((data) => {
  ...
  openDialog(academicQualification?: AcademicQualification) {
    ...
    const dialogRef = this.dialog.open(AcademicQualificationDialogComponent, dialogConfig);
  ...
  deleteAcademicQualification(academicQualification: AcademicQualification) {
    this.academicQualificationService.deleteAcademicQualification(academicQualification.id).subscribe(() => this.ngOnInit());
  }
